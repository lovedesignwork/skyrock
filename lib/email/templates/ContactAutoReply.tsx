...
export const ContactAutoReply = ({
  ...
  const previewText = `Thank you for contacting Sky Rock Khao Lak`;
        ...
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Text style={paragraph}>
              Thank you for contacting Sky Rock Khao Lak. We have received your message 
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style={contactInfo}>
                    ...
                    <Link href="mailto:info@skyrockkhaolak.com" style={contactLink}>
          ...
          <Section style={ctaSection}>
            <Text style={ctaText}>
              While you wait, why not explore our adventure packages?
            </Text>
          ...
          <Section style={footer}>
            ...
            <Text style={footerLinks}>
              ...
              {' • '}
              <Link href="https://facebook.com/skyrockphuket" style={footerLink}>Facebook</Link>
              {' • '}
              <Link href="https://instagram.com/skyrockphuket" style={footerLink}>Instagram</Link>
            </Text>
            <Text style={copyright}>
              © {new Date().getFullYear()} Sky Rock Khao Lak. All rights reserved.
            </Text>
          </Section>
        </Container>
      </Body>
