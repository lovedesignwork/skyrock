        ...
        <Container style={container}>
          ...
          <Section style={alertBanner}>
            <Text style={alertText}>
              A new booking has been made on SKY ROCK website
            </Text>
          </Section>
          ...
          <Section style={detailsCard}>
            ...
            <table style={table}>
              <tbody>
                ...
                <tr>
                  <td style={labelCell}>Players:</td>
                  <td style={valueCell}>{players} player{players > 1 ? 's' : ''}</td>
                </tr>
                {nonPlayers && nonPlayers > 0 && (
                  <tr>
                    <td style={labelCell}>Non-Players:</td>
                    <td style={valueCell}>{nonPlayers} person{nonPlayers > 1 ? 's' : ''}</td>
                  </tr>
                )}
                <tr>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              This is an automated notification from SKY ROCK booking system.
            </Text>
            <Text style={footerText}>
