...
const baseUrl = process.env.NEXT_PUBLIC_APP_URL || 'https://skyrockkhaolak.com';
...
export const BookingConfirmationEmail = ({
  ...
  const previewText = `Your SKY ROCK adventure is confirmed! Booking #${bookingRef}`;
        ...
        <Container style={container}>
          ...
          <Section style={successBanner}>
            ...
            <Text style={successSubtitle}>
              Thank you for choosing SKY ROCK, {customerName}!
            </Text>
          </Section>
          ...
          <Section style={notesSection}>
            ...
            <Text style={noteText}>
              ⚖️ Weight limit: 15kg - 130kg per participant
            </Text>
            <Text style={noteText}>
              🚫 Not suitable for pregnant women or those with heart conditions
            </Text>
            <Text style={noteText}>
          ...
          <Section style={contactSection}>
            ...
            <Text style={contactText}>
              📧 Email: <Link href="mailto:info@skyrockkhaolak.com" style={contactLink}>info@skyrockkhaolak.com</Link>
            </Text>
            <Text style={contactText}>
              📞 Phone: <Link href="tel:+6676391222" style={contactLink}>+66 76 391 222</Link>
            </Text>
            <Text style={contactText}>
              💬 LINE: @skyrock
            </Text>
          ...
          <Section style={footer}>
            ...
            <Text style={footerText}>
              Thailand's Biggest Zipline Adventure
            </Text>
            <Row style={socialRow}>
              <Column style={socialCol}>
                <Link href="https://www.facebook.com/skyrockphuket" style={socialLink}>
                  Facebook
                </Link>
              </Column>
              <Column style={socialCol}>
                <Link href="https://www.instagram.com/skyrockphuket" style={socialLink}>
                  Instagram
                </Link>
              </Column>
              <Column style={socialCol}>
                <Link href="https://www.tripadvisor.com/" style={socialLink}>
                  TripAdvisor
                </Link>
              </Column>
            </Row>
