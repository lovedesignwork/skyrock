...
function CancelContent() {
  ...
  return (
    <main className="min-h-screen pt-20 bg-gradient-to-b from-[#991B1B] to-[#DC2626]">
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="space-y-3 mb-8">
              ...
              <Link href="/booking" className="block">
                <div className="flex items-center gap-4 p-4 bg-[#DC2626]/5 hover:bg-[#DC2626]/10 rounded-xl transition-colors cursor-pointer">
...
export default function CancelPage() {
  return (
    <Suspense fallback={
      <main className="min-h-screen pt-20 bg-gradient-to-b from-[#991B1B] to-[#DC2626] flex items-center justify-center">
