      ...
      <Container>
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            {partners.map((partner, index) => (
              <motion.div
                ...
                className="text-white/30 hover:text-white/60 transition-colors duration-300 text-xl md:text-2xl font-bold font-heading cursor-pointer"
              >
                {partner.text}
              </motion.div>
            ))}
        ...
        >
          ...
          <div className="flex items-center gap-3 px-5 py-3 rounded-full bg-white/5 border border-white/10">
            ...
            <span className="text-white/70 text-sm">Best Adventure Park 2023</span>
          </div>
        </motion.div>
      </Container>
    </Section>
