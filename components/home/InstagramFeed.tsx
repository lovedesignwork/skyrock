    ...
    <Section className="relative overflow-hidden" style={{ backgroundColor: '#991B1B' }}>
      ...
      <Container className="relative z-10">
        <SectionHeader
          ...
          subtitle="Join our community and share your SKY ROCK experience"
        />
        ...
        >
            ...
            <div className="bg-gradient-to-br from-primary/90 to-primary-dark rounded-2xl p-8 animated-card-bg-purple overflow-hidden relative">
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                ...
                <div className="flex-shrink-0 text-center md:text-left">
                  ...
                  <h3 className="mt-4 text-2xl font-bold text-white font-heading">
                    @skyrockphuket
                  </h3>
                ...
                <div className="flex-grow">
                  <div className="grid grid-cols-3 gap-6 text-center mb-6">
                    ...
                    <div>
                      <div className="text-3xl font-bold text-white font-heading">15K+</div>
                      <div className="text-white/60 text-sm">Followers</div>
                    </div>
                    <div>
                      <div className="text-3xl font-bold text-white font-heading">1K+</div>
                      <div className="text-white/60 text-sm">Following</div>
                    </div>
                  </div>
                  
                  <p className="text-white/80 text-center md:text-left mb-6">
                    🌴 Thailand&apos;s Premier Zipline Adventure<br />
                    📍 Phuket, Thailand<br />
                    🎢 Zipline • Roller • Skywalk • Slingshot
                  </p>
                  
                  <a 
                    href="https://www.instagram.com/skyrockphuket/" 
                    target="_blank" 
          ...
          <p className="text-white/60 mt-8 text-center">
            Tag us in your photos with <span className="text-accent font-semibold">#skyrock</span> for a chance to be featured!
          </p>
        </motion.div>
      </Container>
    </Section>
