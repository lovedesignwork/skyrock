          ...
          {activeTab === 'upload' && (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                {uploading ? (
                  <>
                    <Loader2 className="w-10 h-10 text-[#DC2626] animate-spin mb-3" />
          ...
          {activeTab === 'url' && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-[#DC2626] hover:bg-[#DC2626]/90 text-white rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Insert Image
              </button>
            </div>
