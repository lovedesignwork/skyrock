            ...
            {showUrlInput ? (
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-slate-200 rounded-lg text-sm text-slate-800 focus:outline-none focus:border-[#DC2626]"
                  onKeyDown={(e) => e.key === 'Enter' && handleUrlSubmit()}
                />
                <button
                  type="button"
                  onClick={handleUrlSubmit}
                  className="px-3 py-2 bg-[#DC2626] hover:bg-[#DC2626]/90 text-white text-sm rounded-lg transition-colors"
                >
                  Add
                </button>
                <button
              ...
              <button
                ...
                className="flex items-center gap-2 text-sm text-slate-500 hover:text-[#DC2626] transition-colors"
              >
