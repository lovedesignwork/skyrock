          ...
          <Section id="focus-keyword" title="Focus Keyword">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-slate-200 rounded-lg text-slate-800 text-sm focus:outline-none focus:border-[#DC2626]"
              />
            </div>
            <div>
          ...
          <Section id="meta" title="Meta Title & Description">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 border border-slate-200 rounded-lg text-slate-800 text-sm focus:outline-none focus:border-[#DC2626] resize-none"
              />
            </div>
          </Section>
          ...
          <Section id="preview" title="Google Preview">
            <div className="p-4 bg-slate-50 rounded-lg">
              ...
              <div className="text-green-700 text-sm">
                skyrockkhaolak.com/blog/{slug || 'your-post-url'}
              </div>
          ...
          <Section id="advanced" title="Advanced">
            <div>
              ...
              <input
                ...
                placeholder="https://skyrockkhaolak.com/blog/..."
                className="w-full px-3 py-2 border border-slate-200 rounded-lg text-slate-800 text-sm focus:outline-none focus:border-[#DC2626]"
              />
            </div>
          ...
          <Section id="og" title="Facebook / Open Graph">
            ...
            <div className="p-4 bg-slate-50 rounded-lg">
              ...
              <div className="border border-slate-200 rounded-lg overflow-hidden bg-white">
                ...
                <div className="p-3">
                  <div className="text-xs text-slate-400 uppercase">skyrockkhaolak.com</div>
            ...
            <div className="p-4 bg-slate-50 rounded-lg">
              ...
              <div className="border border-slate-200 rounded-xl overflow-hidden bg-white">
                ...
                <div className="p-3">
                  ...
                  <div className="text-xs text-slate-400 mt-1">skyrockkhaolak.com</div>
                </div>
              </div>
            </div>
          </Section>
