        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
              ...
              {error && (
                <div className="text-center py-12">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#DC2626] text-white rounded-lg hover:bg-[#DC2626]/90 transition-colors"
                  >
                    Try Again
                  </button>
                </div>
            ...
            <div className="sticky bottom-0 bg-white border-t border-slate-200 px-6 py-4 flex justify-end">
              <button
                onClick={onClose}
                className="px-6 py-2 bg-[#DC2626] text-white rounded-lg hover:bg-[#DC2626]/90 transition-colors font-medium"
              >
                Close
              </button>
            </div>
  ...
  const parseMarkdown = (text: string) => {
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (line === '') {
        ...
        elements.push(
          <h2 key={i} className="text-lg font-bold text-[#DC2626] mt-6 mb-3 flex items-center gap-2">
