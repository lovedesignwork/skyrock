    ...
    <div ref={containerRef} className="relative">
      <div className="relative">
        ...
        <button
          ...
          className="w-full h-11 pl-10 pr-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:outline-none focus:border-[#DC2626] text-left"
        >
      ...
      {isOpen && (
        <div 
          ...
          style={{ border: '3px solid #0d2842', minWidth: '340px' }}
        >
          {/* Header */}
